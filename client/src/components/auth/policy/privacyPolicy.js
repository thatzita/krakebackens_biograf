...
export default function privacyPolicy() {
  return (
    <div style={{ color: "white", backgroundColor: "#1B1C1D" }}>
      <h1>Privacy Policy for Kråkebackens biograf</h1>

      <p>
        At Kråkebackens biograf, accessible from http://kråkebackensbiograf.se,
        one of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and
        recorded by Kråkebackens biograf and how we use it.
      </p>

      <p>
        If you have additional questions or require more information about our
        Privacy Policy, do not hesitate to contact us through email at
        krakebackensbiograf@gmail.com
      </p>

      <h2>Log Files</h2>

      <p>
        Kråkebackens biograf follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, Kråkebackens biograf uses 'cookies'. These
      ...
      <p>
        ...
        advertising partners of Kråkebackens biograf.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Kråkebackens biograf, which are
      ...
      <p>
        Note that Kråkebackens biograf has no access to or control over these
      ...
      <p>
        Kråkebackens biograf's Privacy Policy does not apply to other
      ...
      <p>
        Kråkebackens biograf does not knowingly collect any Personal
      ...
      <p>
        ...
        shared and/or collect in Kråkebackens biograf. This policy is not
        applicable to any information collected offline or via channels other
        than this website.{" "}
        <a href="https://gdprprivacynotice.com/#wizard">
          Our GDPR Privacy Policy
        </a>{" "}
        was generated from the Privacy Policy Generator.
      </p>
